...
const ForgotUsername = () => {
    ...
    const [step, setStep] = useState(1); // 1: Email, 2: OTP, 3: New Username
    ...
    const handleVerifyOtp = async (e) => {
        ...
        try {
            ...
            setMessage("OTP Verified! Enter new username.");
        } catch (err) {
    ...
    const handleResetUsername = async (e) => {
        ...
        try {
            await AuthService.resetUsername(email, otp, newUsername);
            setMessage("Username updated successfully! strictly Redirecting to login...");
            setTimeout(() => {
